                    ...
                    <el-collapse-item title="开始导入" name="2">
                        <el-form @submit.native.prevent>
                            <el-form-item label="ID/URL">
                                <el-input placeholder="请输入内容" v-model="input_playlist"
                                          @keyup.enter.native="handleSearchPlayList(input_playlist)">
                                    <el-button slot="append" icon="el-icon-search" @click="handleSearchPlayList(input_playlist)">
                                    </el-button>
                                </el-input>
                            </el-form-item>
                        </el-form>
